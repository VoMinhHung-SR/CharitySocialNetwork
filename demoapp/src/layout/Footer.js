...
const Footer = () => {
    return(
        <>
            <div style={{"backgroundColor":"#333", "color":"white","padding":"50px"}}>
                <Container> 
                    <Grid container spacing={2} columns={12}>
                        <Grid item xs={4}>
                            <Avatar sx={{width:'200px',  height:'50px', }} variant="square" src="https://res.cloudinary.com/dl6artkyb/image/upload/v1650614096/Demo/logo-full_280px__white_aupcq7.png"></Avatar>
                        </Grid>
                        <Grid item xs={6}>
                        ...
                        <Grid item xs={2}>
                            <div>
                                ...
                                <Stack direction="row" spacing={2} style={{ "flexDirection":"column"}}>
                                    <div style={{"textDecoration":"none","color":"#ed5338","marginLeft":"0px","cursor":"pointer"}}>Bảo mật</div>
                                    <div style={{"textDecoration":"none","color":"#ed5338","marginLeft":"0px","cursor":"pointer"}}>Quyền riêng tư</div>
                                    <div style={{"textDecoration":"none","color":"#ed5338","marginLeft":"0px","cursor":"pointer"}}>Trợ giúp</div>
                                </Stack> 
                            </div>
                            <div style={{"paddingTop":"20px"}}>
                                <h4>Về Chúng Tôi</h4>
                                <Stack direction="row" spacing={2} style={{ "flexDirection":"column"}}>
                                    <div style={{"textDecoration":"none","color":"#ed5338","marginLeft":"0px","cursor":"pointer"}}>Giới thiệu</div>
                                    <div style={{"textDecoration":"none","color":"#ed5338","marginLeft":"0px","cursor":"pointer"}}>Liên Hệ</div>
                                    <div style={{"textDecoration":"none","color":"#ed5338","marginLeft":"0px","cursor":"pointer"}}>Chứng Nhận</div>
                                </Stack> 
                            </div>
                        </Grid>
                    </Grid>
